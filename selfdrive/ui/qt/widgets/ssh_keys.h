...
public:
  DrivingRecordToggle() : ToggleControl("Enable Auto Recording", "Automatically record/stop the screen while driving. Recording starts after departure and ends when the vehicle stops.", "../assets/offroad/icon_shell.png", Params().getBool("OpkrDrivingRecord")) {
...
public:
  ApksEnableToggle() : ToggleControl("Use APKs", "Activate the apk environment to use the application. Upon activation, the apk files (softkey, mappy, mixflower, etc.) are automatically installed.", "../assets/offroad/icon_shell.png", Params().getBool("OpkrApksEnable")) {
